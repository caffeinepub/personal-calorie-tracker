...
export class Backend implements backendInterface {
    ...
    async getAllStepRecords(): Promise<Array<StepRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllStepRecords();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAvailableDates(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAvailableDates();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getEntriesForDate(arg0: string): Promise<Array<FoodEntry>> {
        if (this.processError) {
            try {
    ...
    async getSteps(arg0: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getSteps(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
